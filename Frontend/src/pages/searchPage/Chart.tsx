...
import {getHistoricalData} from "../../api/stock-api";
...
export const Chart = () => {
    ...
    const formatData = (data: any) => {
        return data.c.map((item: number, index: string | number) => {
            return {
    ...
    return <Card>
                <ul className='flex absolute top-2 right-2 z-40 md:top-1 md:right-1'>
